...
class ASRDataset(Dataset):
    def __init__(
        ...
        self.fbank_files = sorted([os.path.join(self.fbank_dir, fname) for fname in os.listdir(self.fbank_dir)])
    ...
    def collate_fn(self, batch) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        raise (padded_feats, padded_shifted, padded_golden, feat_lengths, transcript_lengths)# Remove once implemented
